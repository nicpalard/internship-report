...
L'avantage de cette technique est que comme OpenCL, OpenGL ES est largement compatible sur toutes les plateforme et très largement utilisé. Cependant contrairement à OpenCL, les performances d'OpenGL ne dépendent que du matériel et ne varieront pas ou que très peu d'un système à un autre.
