...
% Parler prochaine étape de l'appli était de récuperer le nuage de points 3d pour aussi pouvoir voir la main et les objets physique qu'on passait derriere.

\section{Conclusion}
% Parler des points fort et faible du module Unity -> justifier la refonte actuelle -> les fonctionnalités manquantes comme par exemple la gestion des clefs avec le nom des composants, les ajouts, le nouveau pipeline evenementiel alleger et fonctionnant dans Unity, la refonte du protocole de transfert des données etc.
